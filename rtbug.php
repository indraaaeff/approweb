...
//---------------------------------------------------------------------------------------------------------------------------------
		    $message1->From     = 'indra <indraeff@hts.net.id>';
		    $message1->To       = 'indra <indraeff@hts.net.id>'; 
		    $message1->CC       = ''; 
		    $message1->BCC      = '';
...
//---------------------------------------------------------------------------------------------------------------------------------
		    $message2->From     = 'indra <indraeff@hts.net.id>';
		    $message2->To       = 'indra <indraeff@hts.net.id>'; 
		    $message2->CC       = ''; 
		    $message2->BCC      = '';
...
//---------------------------------------------------------------------------------------------------------------------------------
		    $message3->From     = 'indra <indraeff@hts.net.id>';
		    $message3->To       = 'indra <indraeff@hts.net.id>'; 
		    $message3->CC       = ''; 
		    $message3->BCC      = '';
		    $message3->Subject  = "Notifikasi hasil persetujuan PO ";

		    $message3->HTMLBody = "    <font style='font-size:16px; font-weight:bold;'>Data pengajuan PO ini telah selesai diproses. <br />
					Berikut hasilnya :</font>
					<br>
					<table style=' margin-top:10px;'>
					<tr>
...
//---------------------------------------------------------------------------------------------------------------------------------
		    $message4->From     = 'indra <indraeff@hts.net.id>';
		    $message4->To       = 'indra <indraeff@hts.net.id>'; 
		    $message4->CC       = ''; 
		    $message4->BCC      = '';
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------
		    ...
		    for ($i = 0; $i < count($po); $i++) 
		    {
			  ...
			  //------------------------------------------------------------------------------------------------------------------------------------
			   ...
			   ";
			  echo $user . $ppo . $end_po . $prove_rt . $end_tgl . $end_keterangan_rt ;
