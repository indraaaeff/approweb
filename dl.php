                                     ...
                                     count($_POST['po_tgl_approved_dl']) === count($_POST['po_approve_by_dl'])
                                    ) 
                                           {
											...
											$keterangan_rt = $_POST['po_comment_rt'];
                                              ...
                                              /*1*/  $tanggal_dl    = $_POST['po_tgl_approved_dl'];
                                              /*2*/  $app_dl        = $_POST['po_approve_by_dl'];
	                                          /*3*/  $po            = $_POST['no_po'];
											  /*4*/  $vendor        = $_POST['nama_vendor'];
											  /*5*/  $total         = $_POST['total'];
	                                          /*6*/  $tgl_po        = $_POST['tgl_po'];
	                                          /*7*/  $sub_by        = $_POST['sub_by'];
	                                          /*8*/  $keterangan_dl = $_POST['po_comment_dl'];
	                                          /*9*/  $y             = $_POST['x'];
	                                          /*10*/ $t             = $_POST['t']; 
...
<td align='center' style='padding:8px;  border-spacing: 0; border-collapse: collapse; border:solid 1px #555;'> NOTE </td>
                                        ...
                                        /*1*/     $tgl_dl                = $tanggal_dl[$i];
                                        /*2*/     $prove_dl              = $app_dl[$i];  	                                              
										/*3*/	  $end_po                = $po[$i];
										/*4*/	  $end_vendor            = $vendor[$i];
										/*5*/	  $end_total             = $total[$i];
	                                    /*6*/     $end_tgl_po            = $tgl_po[$i];
	                                    /*7*/     $x                     = $y[$i];
	                                    /*8*/     $tt                    = $t[$i];
	                                    /*9*/     $end_keterangan_dl     = $keterangan_dl[$i];
